...
class Canvas {
    constructor(bool) {
        ...
        if (bool === true) {
            this.canvas.style.position = "fixed"; // Fixed agar menutupi layar
            this.canvas.style.display = "block";
            this.canvas.style.top = 0;
            this.canvas.style.left = 0;
            this.canvas.style.zIndex = "-1"; // Di belakang elemen lain
    ...
    offInit() {
        this.ctx.clearRect(0, 0, this.width, this.height); // Bersihkan canvas sebelum init
...
(function () {
    ...
    window.addEventListener("load", function () {
        ...
        // Memutar lagu saat layar diklik pertama kali (Menghindari blokir browser)
